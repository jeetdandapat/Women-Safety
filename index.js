...
const Volunteer = require('./models/Volunteer'); // ✅ FIXED - assign model to variable
const User = require("./models/User"); // already used later, keeping here
  ...
  .then(() => {
    ...
    app.get("/WomenDashboard", isAuthenticated, async (req, res) => {
      try {
        ...
        const volunteers = await Volunteer.find(); // ✅ This will now work!
